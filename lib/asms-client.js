module.exports = function(app, cf) {
    ...
    var objectTypes = ['Application', 'AppInstance', 'Article', 'Bookmark', 'Comment', 'Event', 'File', 'Folder', 'Group', 'List', 'Note', 'Person', 'Photo', 'Place', 'Playlist', 'Product', 'Review', 'Stream', 'Service', 'Song', 'Status', 'Video'];
    ...
    var getCurrentUserObject = function(session) {
        if (session.user) {
            ...
            var currentUser = {};
            currentUser.displayName = 'UID: '+ session.uid;
