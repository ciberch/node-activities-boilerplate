...
buf.push('><a');
buf.push(attrs({ 'data-toggle':("dropdown"), "class": ('btn') + ' ' + ('btn-link') + ' ' + ('dropdown-toggle') }, {"data-toggle":true}));
buf.push('><span');
...
buf.push(attrs({ 'id':('specific-activity-input'), "class": ('row') }, {}));
buf.push('></div><hr');
buf.push(attrs({  }, {}));
buf.push('/><div');
buf.push(attrs({ "class": ('row') }, {}));
buf.push('><div');
buf.push(attrs({ "class": ('span2') + ' ' + ('offset1') }, {}));
buf.push('><p>To finish you can</p></div><div');
buf.push(attrs({ "class": ('span1') }, {}));
buf.push('><button');
buf.push(attrs({ 'id':('send-message'), "class": ('btn') + ' ' + ('btn-success') }, {}));
buf.push('>Publish</button></div><div');
buf.push(attrs({ "class": ('span2') }, {}));
buf.push('><p>the activity to the</p></div><div');
...
buf.push('><h1>Welcome</h1><p>Login or Sign Up to Share Activities !</p></div>');
}
buf.push('<div');
buf.push(attrs({ "class": ('row') }, {}));
buf.push('><div');
...
buf.push(attrs({ "class": ('row') }, {}));
buf.push('><div');
buf.push(attrs({ "class": ('span8') + ' ' + ('offset2') }, {}));
buf.push('><form');
buf.push(attrs({ 'id':('new_photo'), 'method':("post"), 'enctype':("multipart/form-data"), 'action':("/photos"), "class": ('span8') }, {"method":true,"enctype":true,"action":true}));
buf.push('><div');
buf.push(attrs({ "class": ('span2') }, {}));
buf.push('><div');
buf.push(attrs({ "class": ('input-file') }, {}));
buf.push('><input');
buf.push(attrs({ 'type':("file"), 'name':("image"), 'accept':("image/*"), 'required':("required") }, {"type":true,"name":true,"accept":true,"required":true}));
buf.push('/></div></div><div');
buf.push(attrs({ "class": ('span2') }, {}));
buf.push('><input');
buf.push(attrs({ 'type':("submit"), 'value':("Upload File"), "class": ('btn') + ' ' + ('btn-info') }, {"type":true,"value":true}));
buf.push('/></div></form></div></div><div');
buf.push(attrs({ "class": ('row') }, {}));
buf.push('><div');
buf.push(attrs({ "class": ('span8') + ' ' + ('offset1') }, {}));
buf.push('><div');
...
buf.push(attrs({ "class": ('span8') }, {}));
buf.push('><input');
buf.push(attrs({ 'id':('input-title'), 'type':("text"), 'placeholder':("Describe the photo"), 'id':('title'), "class": ('span8') }, {"type":true,"placeholder":true}));
buf.push('/></div></div><div');
buf.push(attrs({ "class": ('row') }, {}));
buf.push('><div');
buf.push(attrs({ "class": ('span8') }, {}));
buf.push('><input');
buf.push(attrs({ 'type':("text"), 'placeholder':("Url of photo on another site ?"), 'id':('url'), "class": ('span8') }, {"type":true,"placeholder":true}));
buf.push('/></div></div><div');
buf.push(attrs({ "class": ('row') }, {}));
buf.push('><div');
buf.push(attrs({ "class": ('span6') }, {}));
