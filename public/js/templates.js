...
buf.push('><a');
buf.push(attrs({ 'data-toggle':("dropdown"), "class": ('btn') + ' ' + ('dropdown-toggle') }, {"data-toggle":true}));
buf.push('><span');
...
buf.push('/></div><div');
buf.push(attrs({ "class": ('clearfix') }, {}));
buf.push('></div><h4>Step 2: Upload to Cloud Foundry</h4><input');
...
buf.push('<div');
buf.push(attrs({ 'id':('details'), "class": ('span7') }, {}));
buf.push('><div');
buf.push(attrs({ "class": ('row') }, {}));
buf.push('><div');
buf.push(attrs({ "class": ('span7') }, {}));
...
buf.push(attrs({ 'id':('includeLocation'), 'type':("checkbox") }, {"type":true}));
buf.push('/><span>Include Location ?</span></label></div></div><div');
buf.push(attrs({ 'id':('map'), "class": ("hide") }, {"class":true}));
buf.push('></div></div></div>');
}
return buf.join("");
}
